...
class _ClickyButtonState extends State<ClickyButton> {
  double _faceLeft = 20.0 * 0.8;
  double _faceTop = 0.0;
  double _sideWidth = 20.0 * 0.8;
  double _bottomHeight = 20.0 * 0.8;
